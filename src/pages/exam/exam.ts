...
export const radioExam: Exam[] = [
  ...
  {
    title:
      '软件维护时，对测试阶段未发现的错误进行测试、诊断、定位、纠错，直至修改的回归测试过程称（）',
    answer: 'A',
    options: [
      { key: 'A', value: '改正性维护' },
      { key: 'B', value: '适应性维护' },
  ...
  {
    title:
      '一组语句在程序多处出现，为了节省空间，把这些语句放在一个模块中，该模块的内聚度是（  ）的',
    answer: 'C',
    options: [
      { key: 'A', value: '逻辑性' },
      { key: 'B', value: '瞬时性' },
  ...
  {
    title:
      '在一个课程注册系统中，定义了类 CourseSchedule 和类 Course , 并在类 CourseSchedule 中定义了方法 add (c:Course) 和方法 remove (c:Course)，则类 CourseSchedule 和类 Course 之间的关系是（  ）',
    answer: 'C',
    options: [
      { key: 'A', value: '泛化关系' },
      { key: 'B', value: '组合关系' },
